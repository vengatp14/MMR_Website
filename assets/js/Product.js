const products = [
   { name: "ARS STEEL", img: "assets/img/iteams/ARS STEEL.jpg" },
  { name: "ASIAN ENAMEL", img: "assets/img/iteams/ASIAN ENAMEL.jpg" },
  { name: "ASIAN PAINTS", img: "assets/img/iteams/ASIAN PAINTS.jpg" },
  { name: "DALMIA", img: "assets/img/iteams/dalmia.jpg" },
  { name: "FAVICOL", img: "assets/img/iteams/fevicol.jpg" },
  { name: "Fibro Wire", img: "assets/img/iteams/fibro_wire.jpg" },
  { name: "Fybros", img: "assets/img/iteams/fybros.jpg" },
  { name: "Fybros Fan", img: "assets/img/iteams/fybros_fan.jpg" },
  { name: "Prince Pipe", img: "assets/img/iteams/prince_pipe.jpg" },
  { name: "Ultra Tech Cement", img: "assets/img/iteams/ultra_tech_cement.jpg" },
  { name: "Wipro Light", img: "assets/img/iteams/wipro_light.jpg" },
